      ...
      <div class="row">
        ...
        <div class="col">
          <div class="row">
            <div class="col">
              <center>
                {{ formattedSongTimer }} / {{ formattedSongLength }}
              </center>
              <input
                type="range"
                name="seek"
          ...
          <div class="row">
            ...
            <div class="col-sm-auto center">
                ...
                :style="{
                  'background-image':
                    'url(' + require('../assets/images/prev.png') + ')',
                }"
                :disabled="getCurrentSong == null"
              ></button>
              <button
                ...
                :style="{
                  'background-image':
                    'url(' + require('../assets/images/play.png') + ')',
                }"
                @click="playSong()"
                v-if="play == false"
                :disabled="getCurrentSong == null"
              ...
              <button
                ...
                :style="{
                  'background-image':
                    'url(' + require('../assets/images/pause.png') + ')',
                }"
                @click="playSong()"
                v-if="play == true"
                :disabled="getCurrentSong == null"
